    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5'>
        ...
        <div className={`flex-col gap-4 text-sm text-gray-600 ${showFilter ? 'flex' : 'hidden sm:flex'}`}>
          ...
          <p onClick={() => speciality === 'Endocrinologist' ? navigate('/doctors') : navigate('/doctors/Endocrinologist')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === 'Endocrinologist' ? 'bg-[#E2E5FF] text-black ' : ''}`}>Endocrinologist</p>
          <p onClick={() => speciality === 'Nephrologists' ? navigate('/doctors') : navigate('/doctors/Nephrologists')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === 'Nephrologists' ? 'bg-[#E2E5FF] text-black ' : ''}`}>Nephrologists</p>
          <p onClick={() => speciality === 'Orthopedics' ? navigate('/doctors') : navigate('/doctors/Orthopedics')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === 'Orthopedics' ? 'bg-[#E2E5FF] text-black ' : ''}`}>Orthopedics</p>
          <p onClick={() => speciality === 'Rheumatologists' ? navigate('/doctors') : navigate('/doctors/Rheumatologists')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === 'Rheumatologists' ? 'bg-[#E2E5FF] text-black ' : ''}`}>Rheumatologists</p>
          <p onClick={() => speciality === 'Hematologists' ? navigate('/doctors') : navigate('/doctors/Hematologists')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === 'Hematologists' ? 'bg-[#E2E5FF] text-black ' : ''}`}>Hematologists</p>
          ...
          <p onClick={() => speciality === 'Oncologist' ? navigate('/doctors') : navigate('/doctors/Oncologist')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === 'Oncologist' ? 'bg-[#E2E5FF] text-black ' : ''}`}>Oncologist</p>
          <p onClick={() => speciality === 'Pulmonogist' ? navigate('/doctors') : navigate('/doctors/Pulmonogist')} className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 border border-gray-300 rounded transition-all cursor-pointer ${speciality === 'Pulmonogist' ? 'bg-[#E2E5FF] text-black ' : ''}`}>Pulmonogist</p>
        </div>
